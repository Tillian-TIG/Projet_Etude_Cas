...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("1", "Aceuil", Model_Menu.MenuType.MENU));
      //  listMenu1.addItem(new Model_Menu("menu", "Aceuil", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("8", "Ajouter un Membre", Model_Menu.MenuType.MENU));
         listMenu1.addItem(new Model_Menu("5", "Gestion du Ressource", Model_Menu.MenuType.MENU));
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#267871"), 0, getHeight(), Color.decode("#136a8a"));
        g2.setPaint(g);
