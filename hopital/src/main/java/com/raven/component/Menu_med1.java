...
public class Menu_med1 extends javax.swing.JPanel {
    ...
    private void init() {
         ...
         listMenu1.addItem(new Model_Menu("menu", "Accueil", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("8", "Dossier Medical", Model_Menu.MenuType.MENU));
       listMenu1.addItem(new Model_Menu("5", "liste des Operations", Model_Menu.MenuType.MENU));
