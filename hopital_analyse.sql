...
CREATE TABLE `analyse` (
  ...
  `typeAnalyse` char(35) DEFAULT NULL,
  PRIMARY KEY (`idAnalyse`),
  KEY `FK_association15` (`idDm`),
  CONSTRAINT `FK_association15` FOREIGN KEY (`idDm`) REFERENCES `dm` (`idDm`) ON DELETE RESTRICT ON UPDATE RESTRICT
