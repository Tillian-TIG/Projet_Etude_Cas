...
CREATE TABLE `autoriser` (
  ...
  KEY `FK_autiriser` (`id`),
  CONSTRAINT `FK_autiriser` FOREIGN KEY (`id`) REFERENCES `autorisation` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_permission` FOREIGN KEY (`Rol_id`) REFERENCES `role` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2023-04-11 16:25:11
