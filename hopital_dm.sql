...
CREATE TABLE `dm` (
  ...
  `dateNaisssance` date DEFAULT NULL,
  PRIMARY KEY (`idDm`),
  KEY `FK_creationDm` (`idUser`),
  CONSTRAINT `FK_creationDm` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE RESTRICT ON UPDATE RESTRICT
