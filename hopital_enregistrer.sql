...
CREATE TABLE `enregistrer` (
  ...
  PRIMARY KEY (`idUser`,`idConsultation`),
  KEY `FK_enregistrer` (`idConsultation`),
  CONSTRAINT `FK_consultation` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_enregistrer` FOREIGN KEY (`idConsultation`) REFERENCES `consultation` (`idConsultation`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2023-04-11 16:25:10
