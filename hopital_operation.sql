...
CREATE TABLE `operation` (
  ...
  `idDm` int NOT NULL,
  `libelleOperation` char(30) DEFAULT NULL,
  `prix` int DEFAULT NULL,
  PRIMARY KEY (`idOperation`),
  KEY `FK_association10` (`idDm`),
  CONSTRAINT `FK_association10` FOREIGN KEY (`idDm`) REFERENCES `dm` (`idDm`) ON DELETE RESTRICT ON UPDATE RESTRICT
