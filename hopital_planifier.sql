...
CREATE TABLE `planifier` (
  ...
  PRIMARY KEY (`idUser`,`idAnalyse`),
  CONSTRAINT `FK_analyse` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
LOCK TABLES `planifier` WRITE;
/*!40000 ALTER TABLE `planifier` DISABLE KEYS */;
